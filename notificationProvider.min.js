...
q;return e}var u=c||{},g=document.title;navigator.vibrate&&l&&navigator.vibrate(l);if(n()&&b){var v=setInterval(function(){document.title=document.title===g?d:g},1E3),m=function(){clearInterval(v);document.title=g;document.removeEventListener("visibilitychange",m)};document.addEventListener("visibilitychange",m)}return a&&b&&("granted"===a.permission||a.checkPermission&&0==a.checkPermission())?t(d,u):null}}},toggle:function(){b=!b;localStorage.setItem("notifications",b.toString());a&&b&&("default"===
